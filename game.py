...
def is_correct(guess, a_follower,b_follower):
...
while game_should_continue:
  ...
  #get follower count of each account.
    ...
    b_follower_acount=account_b["follower_count"]
        ...
        #user if  statement to check if user is correcct.

    is_correct(guess,a_follower_acount,b_follower_acount)
    ...
    #give user feddback on their games.
    if is_correct:
        score+=1
